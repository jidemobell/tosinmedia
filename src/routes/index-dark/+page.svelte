...
<script>
	  import '$styles/css/dark-color.css'
</script>
<main>
	<!--[if lte IE 9]>
			...
			<div class="section" data-anchor="first-section">
				...
				<div class="hero-area">
					...
					<div class="hero-slider hero-silder-active">
						...
						<div class="hero-single-slide bg-image-6" data-black-overlay="2">
							<div class="container">
						...
						<!-- Hero Area Single Slide -->
						<div class="hero-single-slide bg-image-7" data-black-overlay="2">
							<div class="container">
								<div class="hero-slide-text">
									<h1>Stay With Your <br>Dream & Passion</h1>
									<p>Photography is about capturing <br> souls not smiles </p>
						...
						<div class="row align-items-start align-items-xl-center">
							...
							<div class="col-lg-6 col-12 order-1 order-lg-2">
								<div class="about-image">
									<img src="img/others/about-image.jpg" alt="about">
								</div>
							</div>
						</div>
					</div>
							...
							<div class="row">
								...
								<div class="col-lg-6 order-1 order-lg-2">
									<div class="row g-photo-thumbs">
										<div class="col-lg-12">
											<img src="img/portfolio/portfolio-image-6.jpg" alt="portfolio thumb">
										</div>
										<div class="col-lg-12">
											<img src="img/portfolio/portfolio-image-7.jpg" alt="portfolio thumb">
										</div>
										<div class="col-lg-12">
						...
						<div class="row testimonial-slider">
							...
							<div class="col-12">
								<div class="testimonial text-center">
									<span class="testimonial-image"><img src="img/author-image/author-image-3.png" alt="author"></span>
							...
							<div class="col-12">
								<div class="testimonial text-center">
									<span class="testimonial-image"><img src="img/author-image/author-image-4.png" alt="author"></span>
									<p>It is a long established fact that a reader will be has a more-or-less normal distribution of letters, as anopposed formally not using.</p>
									<h5>LUISE HANERIKA</h5>						
									<h6>Fashion Designer</h6>
									<span class="testimonial-border-topleft"></span>
